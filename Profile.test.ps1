...
Describe 'Profile' {
    ...
    Context "Create profile with uppercase and symbols" {
        ($profile, $__) = New-Profile "site.org" -uppercase -symbols
    ...
    Context "Create profile with digits and symbols" {
        ($profile, $__) = New-Profile "site.org" -digits -symbols
    ...
    Context "Create profile with lowercase, uppercase and digits" {
        ($profile, $__) = New-Profile "site.org" -lowercase -uppercase -digits
    ...
    Context "Create profile with lowercase, uppercase and symbols" {
        ($profile, $__) = New-Profile "site.org" -lowercase -uppercase -symbols
    ...
    Context "Create profile with uppercase, digits and symbols" {
        ($profile, $__) = New-Profile "site.org" -uppercase -digits -symbols
    ...
    Context "Create profile with lowercase, uppercase, digits and symbols" {
        ($profile, $__) = New-Profile "site.org" -lowercase -uppercase -digits -symbols
